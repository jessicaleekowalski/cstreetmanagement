...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "C Street Management Group — Commercial Property Maintenance" },
      ...
      { property: "og:title", content: "C Street Management Group — Commercial Property Maintenance" },
      { property: "og:description", content: "Commercial property maintenance operations: tenant requests, owner approvals, vendor coordination, and repair history." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary_large_image" },
      { name: "twitter:title", content: "C Street Management Group — Commercial Property Maintenance" },
      { name: "twitter:description", content: "Commercial property maintenance operations: tenant requests, owner approvals, vendor coordination, and repair history." },
